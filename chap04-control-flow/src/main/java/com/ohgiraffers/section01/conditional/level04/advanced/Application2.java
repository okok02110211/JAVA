...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        int month_sales = sc.nextInt();
        int bonus = 0;
        int bonus_percent = 0;
        if (month_sales < 10000000){
            bonus_percent = 0;
            bonus = (month_sales / 100) * bonus_percent;
        }else if (month_sales >= 10000000 && month_sales < 30000000){
            bonus_percent = 1;
            bonus = (month_sales / 100) * bonus_percent;
        }else if (month_sales >= 30000000 && month_sales < 50000000){
            bonus_percent = 3;
            bonus = (month_sales / 100) * bonus_percent;
        }else if (month_sales >= 50000000){
            bonus_percent = 5;
            bonus = (month_sales / 100) * bonus_percent;
        }

        System.out.println("매출액 : " + month_sales);
        System.out.println("보너스율 : " + bonus_percent+"%");
